...
import gplay from "../../../public/images/gplay.png";
  ...
  return (
    <>
      <div className="py-10 md:flex  lg:w-[100%]">
        <div className="  h-auto md:w-[100%]  md:h-40 flex px-5 md:mb-6 lg:px-24 lg:mb-24 ">
          <div className=" h-auto md:w-[100%] pb-16 md:flex md:h-56 md:justify-between  ">
            <div className="md:w-64 lg:w-80">
              ...
              <div className="w-full mt-5 flex flex-col justify-between md:h-32">
                ...
                <div className="flex mt-2 md:hidden md:w-24 lg:w-40">
                  <svg
                  ...
                  <h1 className="text-sm ml-2 text-fourth lg:mb-3">
                    Jakarta, Indonesia
                  </h1>
                </div>
                <div className="hidden md:block md:mt-4">
                  <h1 className=" text-sm md:text-base text-fourth">
                    © Ankasa. <br /> All Rights Reserved.
                  </h1>
                </div>
              </div>
            </div>
            <div className=" flex  h-auto md:h-auto mt-8 md:mt-8">
              <div className=" w-1/2 md:w-1/3 flex flex-col">
                <h1 className=" text-black font-semibold mb-3 md:mb-7 text-sm">
                  Features
                </h1>
                <h1 className="text-fourth mt-2 text-sm md:text-base md:mt-3">
                  Find Ticket
                </h1>
                <h1 className="text-fourth mt-2 text-sm md:text-base md:mt-3">
                  My Booking
              ...
              <div className=" w-1/2 md:w-2/3 md:ml-6 lg:ml-20 ">
                <h1 className=" text-center text-black font-semibold mb-3 md:mb-7 text-sm">
                  Download Ankasa app
                </h1>
                <Image
                  src={appStore}
                  ...
                  alt="appStore"
                />
                <Image src={gplay} className="w-full" alt="gplay" />
              </div>
            </div>{" "}
            <div className=" flex mt-5 md:mt-8">
              ...
              <div className=" w-1/2  flex items-center justify-between md:w-full md:flex-col md:items-start md:">
                <div className="w-full">
                  <h1 className="hidden md:block text-center md:text-start text-black font-semibold mb-3 md:mb-7 text-sm">
                    Follow us
                  </h1>
                  <div className="flex justify-between md:items-start md:w-28 lg:w-40">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="27"
                      height="27"
                ...
                <div className="hidden md:flex md:items-center md:w-24 lg:w-40 lg:items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                  ...
                  <h1 className="text-sm ml-2 text-fourth">
                    Jakarta, Indonesia
                  </h1>
                </div>
              </div>
