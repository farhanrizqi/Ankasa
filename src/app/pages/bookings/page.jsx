...
function Bookings() {
  ...
  return (
    <div>
      <Navbar />
      <div className="Main w-full h-auto bg-gray-300 p-5 flex flex-col justify-center items-center lg:items-start lg:flex-row">
        <div className="Left w-full h-auto bg-white rounded-2xl p-7 flex flex-col items-center lg:w-1/3">
          <div className="flex flex-col items-center gap-4">
            ...
            <h1 className="text-md font-extrabold">Carter Slade</h1>
          ...
          <div className="w-full mt-8 px-1">
            <div className="flex justify-between">
              <div className="flex items-center">
                ...
                <h1 className="text-md font-bold ml-4">Profile</h1>
              </div>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex justify-between mt-5">
              <div className="flex items-center">
                ...
                <h1 className="text-md font-bold ml-5">My Review</h1>
              </div>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex justify-between mt-5">
              <div className="flex items-center">
                ...
                <h1 className="text-md font-bold ml-5">Settings</h1>
              </div>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="Right w-full h-auto bg-white rounded-2xl p-7 flex flex-col items-center mt-5 lg:p-8 lg:ml-3 lg:h-auto lg:mt-3">
            <div className="w-full flex flex-col p-7 items-start">
              ...
              <div className="flex items-center gap-8 mt-3">
                <h1 className="text-md font-extrabold">IDN</h1>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="17"
                ...
                <h1 className="text-md font-extrabold">JPN</h1>
              </div>
              <h1 className="text-md text-customGray mt-3">
                Garuda Indonesia, AB-221
              </h1>
            </div>
            <div className="w-full p-7 items-center justify-start border-t border-customGray md:flex md:justify-between">
              <div className="w-full flex  items-center">
                <h1 className="text-md font-extrabold text-secondary">
                  Status
                </h1>
                <button
                  className="block px-4 py-1 ml-3 bg-customOrange border border-customOrange rounded-lg text-xs text-white font-bold "
                  onClick
                >
                  Waiting for payment
                </button>
              </div>
              <div className="w-full flex items-center mt-5 md:mt-0 md:w-1/4 md:justify-end">
                <h1 className="text-md font-extrabold text-primary">
                  View Details
                </h1>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
